...
public class InformacionUsuarios extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(InformacionUsuarios.class.getName());
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("INFORMACION DE PRESTAMOS PENDIENTES");
    ...
    public javax.swing.JTable getTblInformacion() {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new InformacionUsuarios().setVisible(true));
    }
