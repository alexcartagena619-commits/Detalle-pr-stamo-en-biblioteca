 ...
 * @author user
 */
public class InicioBibliotcario extends javax.swing.JFrame implements LogeoVista {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(InicioBibliotcario.class.getName());

    /**
     * Creates new form PrestamoVista
     */
    public InicioBibliotcario() {
        initComponents();
    }
...
//        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new InicioBibliotcario().setVisible(true));
    }
