 ...
 * @author user
 */
public class InicioEstudiante extends javax.swing.JFrame implements LogeoVista {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(InicioEstudiante.class.getName());
...
//        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new InicioEstudiante().setVisible(true));
    }
